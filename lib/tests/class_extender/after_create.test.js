...
describe('@AfterCreate tests', function () {
    var ClassA = /** @class */ (function () {
        ...
        ClassA.y = 13;
        ClassA = __decorate([
            class_decorator_util_1.AfterCreate(function (instance) { instance.some_name = instance.some_name.toUpperCase(); }),
    ...
    var ClassB = /** @class */ (function () {
        ...
        ClassB = __decorate([
            class_decorator_util_1.AfterCreate(function (instance) { instance.x += 1; }),
            class_decorator_util_1.AfterCreate(function (instance) { instance.x += 1; }),
    ...
    function Add_To_X(value) {
        return class_decorator_util_1.AfterCreate(function (instance) { return instance.x += value; });
    }
